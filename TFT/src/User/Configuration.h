...
#define CUSTOM_6_GCODE "M502\n"
  ...
  #define CUSTOM_7_LABEL "Allow move without home"
  #define CUSTOM_7_GCODE "M564 H0\n"
  #define CUSTOM_8_LABEL "Allow Extrude"
  #define CUSTOM_8_GCODE "M302 P1\n"
  #define CUSTOM_9_LABEL "Run bed.g"
  #define CUSTOM_9_GCODE "G32\n"
#endif
